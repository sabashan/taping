...
@Embeddable
@XmlRootElement
public class MerordersheetgroupId extends BaseObject implements Serializable {
    /**
	 * 
	 */
    ...
    public MerordersheetgroupId() {
		super();
	}
    
    
	public MerordersheetgroupId(Long groupId, Long groupSettingId,
    ...
    public boolean equals(Object o) {
        ...
        MerordersheetgroupId pojo = (MerordersheetgroupId) o;
    ...
    public int hashCode() {
        ...
        result = (groupSettingId != null ? groupSettingId.hashCode() : 0);
