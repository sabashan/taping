...
@Entity
@Table(name="mststylechild_color")
@XmlRootElement
public class MststylechildColor extends BaseObject implements Serializable {
    private MststylechildColorId id;
    private Mststyleheader mststyleheader;
    private Long packQty;

    public MststylechildColor(MststylechildColorId id,
	...
	public MststylechildColor() {
		super();
		// TODO Auto-generated constructor stub
	}

	@EmbeddedId @DocumentId    
    public MststylechildColorId getId() {
        return this.id;
    }
    
    public void setId(MststylechildColorId id) {
        this.id = id;
    }
@ManyToOne(fetch=FetchType.LAZY)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MststylechildColor other = (MststylechildColor) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "MststylechildColor [id=" + id + ", packQty=" + packQty + "]";
	}
