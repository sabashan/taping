...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.excelsoft.service.impl.PasswordTokenManager#generateRecoveryToken(com.excelsoft.model.Mstuser)
     */
    @Override
    ...
    /**
     * @see com.excelsoft.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.excelsoft.model.Mstuser, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.excelsoft.service.impl.PasswordTokenManager#invalidateRecoveryToken(Mstuser, String)
     */
    @Override
    public void invalidateRecoveryToken(Mstuser user, String token) {
        jdbcTemplate.update(deleteTokenSql, user.getUsername());
    }

    protected void persistToken(Mstuser user, String token) {
        jdbcTemplate.update(deleteTokenSql, user.getUsername());
        jdbcTemplate.update(insertTokenSql, user.getUsername(), token, getExpirationTime());
    }

    protected boolean isRecoveryTokenPersisted(final Mstuser user, final String token) {
