...
public class StartupListener implements ServletContextListener {
    ...
    public static void setupContext(ServletContext context) {
        ...
        MstparameterManager msiparam = (MstparameterManager) ctx.getBean("mstparameterManager");
        context.setAttribute(Constants.MSTPARAM, msiparam.getAll());
        log.debug("Drop-down MST params initialization complete [OK]");
        MstgencodesManager genmgr = (MstgencodesManager) ctx.getBean("mstgencodesManager");
        context.setAttribute(Constants.GENCODES, genmgr.getAll());
        log.debug("Drop-down GENCODES initialization complete [OK]");
