...
public class SignupController extends BaseFormController {
    ...
    public Mstuser showForm() {
        return new Mstuser();
    }

    @RequestMapping(method = RequestMethod.POST)
    public String onSubmit(final Mstuser user, final BindingResult errors, final HttpServletRequest request, final HttpServletResponse response)
            throws Exception {
