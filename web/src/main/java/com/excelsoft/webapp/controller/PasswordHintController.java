...
public class PasswordHintController {
    ...
    throws Exception {
        ...
        try {
            Mstuser user = userManager.getUserByUsername(username);
           ...
           // msg.append("Your password hint is: ").append(user.getPasswordHint());
            ...
            saveMessage(request, text.getMessage("login.passwordHint.sent", new Object[] { username, user.getEMailAddress() }));
