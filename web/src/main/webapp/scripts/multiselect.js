    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length == 0) {
                    return this.nonSelectedText + ' <i class="glyphicon glyphicon-chevron-down"></i>';
                }
                else {
                    
                    if (options.length > 3) {
                        return options.length + ' ' + this.nSelectedText + ' <i class="glyphicon glyphicon-chevron-down"></i>';
                    }
                    else {
                        var selected = '';
                        ...
                        return selected.substr(0, selected.length - 2) + ' <i class="glyphicon glyphicon-chevron-down"></i>';
                    }
                }
            },
